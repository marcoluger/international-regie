...
const PACKAGES: Record<string, { label: string; color: string; defaults: any }> = {
  starter:    { label: "Starter (bis 5 MA)",      color: "bg-gray-100 border-gray-300",   defaults: { max_employees: 5, max_photos: 2, module_reports: true, module_work_orders: true, module_auto_reports: false, photos_enabled: false, email_enabled: false, signature_enabled: false, comments_enabled: false, material_enabled: false, export_enabled: false, equipment_enabled: false, absence_enabled: false, phonelist_enabled: false, translator_enabled: false, ai_enabled: false, allowed_languages: ["Deutsch"] } },
  team:       { label: "Team (bis 20 MA)",         color: "bg-blue-50 border-blue-300",    defaults: { max_employees: 20, max_photos: 10, module_reports: true, module_work_orders: true, module_auto_reports: false, photos_enabled: true, email_enabled: true, signature_enabled: false, comments_enabled: true, material_enabled: false, export_enabled: false, equipment_enabled: false, absence_enabled: false, phonelist_enabled: true, translator_enabled: true, ai_enabled: true, allowed_languages: ["Deutsch", "Polnisch"] } },
  business:   { label: "Business (bis 100 MA)",   color: "bg-green-50 border-green-300",  defaults: { max_employees: 100, max_photos: 30, module_reports: true, module_work_orders: true, module_auto_reports: true, photos_enabled: true, email_enabled: true, signature_enabled: true, comments_enabled: true, material_enabled: true, export_enabled: true, equipment_enabled: true, absence_enabled: true, phonelist_enabled: true, translator_enabled: true, ai_enabled: true, allowed_languages: ["Deutsch", "Kroatisch", "Slowenisch", "Polnisch", "Englisch"] } },
