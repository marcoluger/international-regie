          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-lg">
              ...
              <div className="md:col-span-2 border-t border-slate-200 pt-2 mt-1 space-y-2">
                <p className="text-sm font-medium">EFB-Formblatt 221 — Zuschläge <span className="font-normal text-gray-500">(je Kostenart; Wagnis und Gewinn = Rest nach BGK+AGK, aufgeteilt nach Anteilen)</span></p>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                  <label className="flex flex-col text-xs">Lohn: BGK %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_bgk_lohn} onChange={(e) => setSettings((x: any) => ({ ...x, efb_bgk_lohn: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">Lohn: AGK %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_agk_lohn} onChange={(e) => setSettings((x: any) => ({ ...x, efb_agk_lohn: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">Material: BGK %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_bgk_mat} onChange={(e) => setSettings((x: any) => ({ ...x, efb_bgk_mat: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">Material: AGK %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_agk_mat} onChange={(e) => setSettings((x: any) => ({ ...x, efb_agk_mat: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">Geräte: BGK %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_bgk_geraet} onChange={(e) => setSettings((x: any) => ({ ...x, efb_bgk_geraet: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">Geräte: AGK %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_agk_geraet} onChange={(e) => setSettings((x: any) => ({ ...x, efb_agk_geraet: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">Fremdleistung: BGK %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_bgk_fremd} onChange={(e) => setSettings((x: any) => ({ ...x, efb_bgk_fremd: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">Fremdleistung: AGK %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_agk_fremd} onChange={(e) => setSettings((x: any) => ({ ...x, efb_agk_fremd: e.target.value }))} /></label>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                  ...
                  <label className="flex flex-col text-xs">Anteil betr. Wagnis %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_anteil_wagnis_betrieb} onChange={(e) => setSettings((x: any) => ({ ...x, efb_anteil_wagnis_betrieb: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">Anteil leist. Wagnis %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_anteil_wagnis_leistung} onChange={(e) => setSettings((x: any) => ({ ...x, efb_anteil_wagnis_leistung: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">1.2 Lohnzusatzkosten %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_lohnzusatz} onChange={(e) => setSettings((x: any) => ({ ...x, efb_lohnzusatz: e.target.value }))} /></label>
                  <label className="flex flex-col text-xs">1.3 Nebenkosten %<input className="border p-1.5 rounded text-black bg-white" value={settings.efb_lohnneben} onChange={(e) => setSettings((x: any) => ({ ...x, efb_lohnneben: e.target.value }))} /></label>
                </div>
              </div>
            </div>
          </div>
