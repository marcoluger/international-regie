...
const EXTRA_LABELS: Record<string, Record<string, string>> = {
  ...
  Kroatisch: {
    planTitle: "Planiranje", planNew: "Novo planiranje", planEquipment: "Oprema", planEmployee: "Radnik",
    planFrom: "Od", planTo: "Do", planNote: "Napomena (nije obavezno)", planSave: "Spremi plan",
    planUpcoming: "Planirane dodjele", planEmpty: "Nema planiranja.", planActive: "u tijeku",
    planPlanned: "planirano", planConflictTitle: "Pozor: preklapanje",
    planConflictText: "Ova oprema je već planirana za odabrano razdoblje:", planSaveAnyway: "Ipak spremi",
    planCancel: "Odustani", planPick: "— odaberite —",
    exportProjectLabel: "Projekt", exportTranslating: "Prevodim djelatnosti…",
    exportByEmployee: "Sati po radniku", exportByProject: "Sati po projektu",
    kmStart: "Početni km", kmEnd: "Završni km", kmDriven: "Prijeđeni km", kmSave: "Spremi km",
    kmWarnNegative: "Završni km manji od početnog – provjerite",
    returnTitle: "Povrat", returnQuestion: "Oštećenje ili posebnost?",
    returnPlaceholder: "npr. ogrebotina straga lijevo, alat neispravan … (nije obavezno)",
    returnConfirm: "Vrati", returnNoteHistory: "Napomena povrata",
    returnNoDamage: "Bez oštećenja", returnDamage: "Oštećenje", returnOther: "Ostalo",
    eqReportTitle: "Mjesečni izvoz", eqReportVehicles: "Vozila CSV", eqReportTools: "Alat CSV",
    colFrom: "Od", colTo: "Do", colDuration: "Trajanje (dana)", colDamage: "Oštećenje / napomena", colOngoing: "još traje",
  },
  Slowenisch: {
    planTitle: "Načrtovanje", planNew: "Novo načrtovanje", planEquipment: "Oprema", planEmployee: "Zaposleni",
    planFrom: "Od", planTo: "Do", planNote: "Opomba (neobvezno)", planSave: "Shrani načrt",
    planUpcoming: "Načrtovane dodelitve", planEmpty: "Ni načrtov.", planActive: "poteka",
    planPlanned: "načrtovano", planConflictTitle: "Pozor: prekrivanje",
    planConflictText: "Ta oprema je za izbrano obdobje že načrtovana:", planSaveAnyway: "Vseeno shrani",
    planCancel: "Prekliči", planPick: "— izberite —",
    exportProjectLabel: "Projekt", exportTranslating: "Prevajam dejavnosti…",
    exportByEmployee: "Ure po zaposlenem", exportByProject: "Ure po projektu",
    kmStart: "Začetni km", kmEnd: "Končni km", kmDriven: "Prevoženi km", kmSave: "Shrani km",
    kmWarnNegative: "Končni km manjši od začetnega – preverite",
    returnTitle: "Vračilo", returnQuestion: "Poškodba ali posebnost?",
    returnPlaceholder: "npr. praska zadaj levo, orodje okvarjeno … (neobvezno)",
    returnConfirm: "Vrni", returnNoteHistory: "Opomba vračila",
    returnNoDamage: "Brez poškodb", returnDamage: "Poškodba", returnOther: "Drugo",
    eqReportTitle: "Mesečni izvoz", eqReportVehicles: "Vozila CSV", eqReportTools: "Orodje CSV",
    colFrom: "Od", colTo: "Do", colDuration: "Trajanje (dni)", colDamage: "Poškodba / opomba", colOngoing: "še poteka",
  },
  Polnisch: {
    planTitle: "Planowanie", planNew: "Nowe planowanie", planEquipment: "Sprzęt", planEmployee: "Pracownik",
    planFrom: "Od", planTo: "Do", planNote: "Notatka (opcjonalnie)", planSave: "Zapisz plan",
    planUpcoming: "Zaplanowane przydziały", planEmpty: "Brak planów.", planActive: "trwa",
    planPlanned: "zaplanowane", planConflictTitle: "Uwaga: nakładanie się",
    planConflictText: "Ten sprzęt jest już zaplanowany w wybranym okresie:", planSaveAnyway: "Zapisz mimo to",
    planCancel: "Anuluj", planPick: "— wybierz —",
    exportProjectLabel: "Projekt", exportTranslating: "Tłumaczę czynności…",
    exportByEmployee: "Godziny wg pracownika", exportByProject: "Godziny wg projektu",
    kmStart: "Km początkowy", kmEnd: "Km końcowy", kmDriven: "Przejechane km", kmSave: "Zapisz km",
    kmWarnNegative: "Km końcowy mniejszy niż początkowy – sprawdź",
    returnTitle: "Zwrot", returnQuestion: "Uszkodzenie lub uwaga?",
    returnPlaceholder: "np. rysa z tyłu po lewej, narzędzie uszkodzone … (opcjonalnie)",
    returnConfirm: "Zwróć", returnNoteHistory: "Notatka zwrotu",
    returnNoDamage: "Brak uszkodzeń", returnDamage: "Uszkodzenie", returnOther: "Inne",
    eqReportTitle: "Eksport miesięczny", eqReportVehicles: "Pojazdy CSV", eqReportTools: "Narzędzia CSV",
    colFrom: "Od", colTo: "Do", colDuration: "Czas trwania (dni)", colDamage: "Uszkodzenie / notatka", colOngoing: "w toku",
  },
  Rumänisch: {
    planTitle: "Planificare", planNew: "Planificare nouă", planEquipment: "Echipament", planEmployee: "Angajat",
    planFrom: "De la", planTo: "Până la", planNote: "Notă (opțional)", planSave: "Salvează planul",
    planUpcoming: "Alocări planificate", planEmpty: "Nicio planificare.", planActive: "în curs",
    planPlanned: "planificat", planConflictTitle: "Atenție: suprapunere",
    planConflictText: "Acest echipament este deja planificat pentru perioada selectată:", planSaveAnyway: "Salvează oricum",
    planCancel: "Anulează", planPick: "— alegeți —",
    exportProjectLabel: "Proiect", exportTranslating: "Traduc activitățile…",
    exportByEmployee: "Ore pe angajat", exportByProject: "Ore pe proiect",
    kmStart: "Km start", kmEnd: "Km final", kmDriven: "Km parcurși", kmSave: "Salvează km",
    kmWarnNegative: "Km final mai mic decât km start – verificați",
    returnTitle: "Returnare", returnQuestion: "Deteriorare sau observație?",
    returnPlaceholder: "ex. zgârietură spate stânga, unealtă defectă … (opțional)",
    returnConfirm: "Returnează", returnNoteHistory: "Notă returnare",
    returnNoDamage: "Fără deteriorări", returnDamage: "Deteriorare", returnOther: "Altele",
    eqReportTitle: "Export lunar", eqReportVehicles: "Vehicule CSV", eqReportTools: "Unelte CSV",
    colFrom: "De la", colTo: "Până la", colDuration: "Durată (zile)", colDamage: "Deteriorare / notă", colOngoing: "în curs",
  },
  Ukrainisch: {
    planTitle: "Планування", planNew: "Нове планування", planEquipment: "Обладнання", planEmployee: "Працівник",
    planFrom: "Від", planTo: "До", planNote: "Примітка (необов'язково)", planSave: "Зберегти план",
    planUpcoming: "Заплановані призначення", planEmpty: "Немає планів.", planActive: "триває",
    planPlanned: "заплановано", planConflictTitle: "Увага: накладання",
    planConflictText: "Це обладнання вже заплановане на вибраний період:", planSaveAnyway: "Все одно зберегти",
    planCancel: "Скасувати", planPick: "— оберіть —",
    exportProjectLabel: "Проєкт", exportTranslating: "Перекладаю роботи…",
    exportByEmployee: "Години за працівником", exportByProject: "Години за проєктом",
    kmStart: "Початковий км", kmEnd: "Кінцевий км", kmDriven: "Пройдено км", kmSave: "Зберегти км",
    kmWarnNegative: "Кінцевий км менший за початковий – перевірте",
    returnTitle: "Повернення", returnQuestion: "Пошкодження чи особливість?",
    returnPlaceholder: "напр. подряпина ззаду ліворуч, інструмент несправний … (необов'язково)",
    returnConfirm: "Повернути", returnNoteHistory: "Примітка повернення",
    returnNoDamage: "Без пошкоджень", returnDamage: "Пошкодження", returnOther: "Інше",
    eqReportTitle: "Місячний експорт", eqReportVehicles: "Транспорт CSV", eqReportTools: "Інструменти CSV",
    colFrom: "Від", colTo: "До", colDuration: "Тривалість (днів)", colDamage: "Пошкодження / примітка", colOngoing: "триває",
  },
  Ungarisch: {
    planTitle: "Tervezés", planNew: "Új tervezés", planEquipment: "Eszköz", planEmployee: "Munkatárs",
    planFrom: "Kezdés", planTo: "Vége", planNote: "Megjegyzés (opcionális)", planSave: "Terv mentése",
    planUpcoming: "Tervezett hozzárendelések", planEmpty: "Nincs tervezés.", planActive: "folyamatban",
    planPlanned: "tervezett", planConflictTitle: "Figyelem: átfedés",
    planConflictText: "Ez az eszköz a kiválasztott időszakra már be van tervezve:", planSaveAnyway: "Mentés mégis",
    planCancel: "Mégse", planPick: "— válasszon —",
    exportProjectLabel: "Projekt", exportTranslating: "Tevékenységek fordítása…",
    exportByEmployee: "Órák munkatársanként", exportByProject: "Órák projektenként",
    kmStart: "Kezdő km", kmEnd: "Záró km", kmDriven: "Megtett km", kmSave: "km mentése",
    kmWarnNegative: "A záró km kisebb a kezdőnél – ellenőrizze",
    returnTitle: "Visszavétel", returnQuestion: "Sérülés vagy megjegyzés?",
    returnPlaceholder: "pl. karcolás hátul balra, szerszám hibás … (opcionális)",
    returnConfirm: "Visszaadás", returnNoteHistory: "Visszavételi megjegyzés",
    returnNoDamage: "Nincs sérülés", returnDamage: "Sérülés", returnOther: "Egyéb",
    eqReportTitle: "Havi export", eqReportVehicles: "Járművek CSV", eqReportTools: "Szerszámok CSV",
    colFrom: "Kezdés", colTo: "Vége", colDuration: "Időtartam (nap)", colDamage: "Sérülés / megjegyzés", colOngoing: "folyamatban",
  },
  Bulgarisch: {
    planTitle: "Планиране", planNew: "Ново планиране", planEquipment: "Оборудване", planEmployee: "Служител",
    planFrom: "От", planTo: "До", planNote: "Бележка (по избор)", planSave: "Запази плана",
    planUpcoming: "Планирани разпределения", planEmpty: "Няма планове.", planActive: "тече",
    planPlanned: "планирано", planConflictTitle: "Внимание: припокриване",
    planConflictText: "Това оборудване вече е планирано за избрания период:", planSaveAnyway: "Запази въпреки това",
    planCancel: "Отказ", planPick: "— изберете —",
    exportProjectLabel: "Проект", exportTranslating: "Превеждам дейностите…",
    exportByEmployee: "Часове по служител", exportByProject: "Часове по проект",
    kmStart: "Начални км", kmEnd: "Крайни км", kmDriven: "Изминати км", kmSave: "Запази км",
    kmWarnNegative: "Крайните км са по-малки от началните – проверете",
    returnTitle: "Връщане", returnQuestion: "Повреда или особеност?",
    returnPlaceholder: "напр. драскотина отзад вляво, дефектен инструмент … (по избор)",
    returnConfirm: "Върни", returnNoteHistory: "Бележка при връщане",
    returnNoDamage: "Без повреди", returnDamage: "Повреда", returnOther: "Друго",
    eqReportTitle: "Месечен експорт", eqReportVehicles: "Превозни средства CSV", eqReportTools: "Инструменти CSV",
    colFrom: "От", colTo: "До", colDuration: "Продължителност (дни)", colDamage: "Повреда / бележка", colOngoing: "все още тече",
  },
  Tschechisch: {
    planTitle: "Plánování", planNew: "Nové plánování", planEquipment: "Vybavení", planEmployee: "Zaměstnanec",
    planFrom: "Od", planTo: "Do", planNote: "Poznámka (nepovinné)", planSave: "Uložit plán",
    planUpcoming: "Naplánovaná přiřazení", planEmpty: "Žádné plány.", planActive: "probíhá",
    planPlanned: "naplánováno", planConflictTitle: "Pozor: překrytí",
    planConflictText: "Toto vybavení je pro zvolené období již naplánováno:", planSaveAnyway: "Přesto uložit",
    planCancel: "Zrušit", planPick: "— vyberte —",
    exportProjectLabel: "Projekt", exportTranslating: "Překládám činnosti…",
    exportByEmployee: "Hodiny podle zaměstnance", exportByProject: "Hodiny podle projektu",
    kmStart: "Počáteční km", kmEnd: "Konečné km", kmDriven: "Ujeté km", kmSave: "Uložit km",
    kmWarnNegative: "Konečné km nižší než počáteční – zkontrolujte",
    returnTitle: "Vrácení", returnQuestion: "Poškození nebo zvláštnost?",
    returnPlaceholder: "např. škrábanec vzadu vlevo, vadné nářadí … (nepovinné)",
    returnConfirm: "Vrátit", returnNoteHistory: "Poznámka k vrácení",
    returnNoDamage: "Bez poškození", returnDamage: "Poškození", returnOther: "Ostatní",
    eqReportTitle: "Měsíční export", eqReportVehicles: "Vozidla CSV", eqReportTools: "Nářadí CSV",
    colFrom: "Od", colTo: "Do", colDuration: "Doba (dny)", colDamage: "Poškození / poznámka", colOngoing: "stále probíhá",
  },
  Türkisch: {
    planTitle: "Planlama", planNew: "Yeni planlama", planEquipment: "Ekipman", planEmployee: "Çalışan",
    planFrom: "Başlangıç", planTo: "Bitiş", planNote: "Not (isteğe bağlı)", planSave: "Planı kaydet",
    planUpcoming: "Planlanan atamalar", planEmpty: "Plan yok.", planActive: "sürüyor",
    planPlanned: "planlandı", planConflictTitle: "Dikkat: çakışma",
    planConflictText: "Bu ekipman seçilen dönem için zaten planlanmış:", planSaveAnyway: "Yine de kaydet",
    planCancel: "İptal", planPick: "— seçin —",
    exportProjectLabel: "Proje", exportTranslating: "Faaliyetler çevriliyor…",
    exportByEmployee: "Çalışana göre saat", exportByProject: "Projeye göre saat",
    kmStart: "Başlangıç km", kmEnd: "Bitiş km", kmDriven: "Gidilen km", kmSave: "km kaydet",
    kmWarnNegative: "Bitiş km başlangıçtan küçük – kontrol edin",
    returnTitle: "İade", returnQuestion: "Hasar veya özel durum?",
    returnPlaceholder: "örn. arka sol çizik, alet arızalı … (isteğe bağlı)",
    returnConfirm: "İade et", returnNoteHistory: "İade notu",
    returnNoDamage: "Hasar yok", returnDamage: "Hasar", returnOther: "Diğer",
    eqReportTitle: "Aylık dışa aktarma", eqReportVehicles: "Araçlar CSV", eqReportTools: "Aletler CSV",
    colFrom: "Başlangıç", colTo: "Bitiş", colDuration: "Süre (gün)", colDamage: "Hasar / not", colOngoing: "devam ediyor",
  },
  Italienisch: {
    planTitle: "Pianificazione", planNew: "Nuova pianificazione", planEquipment: "Attrezzatura", planEmployee: "Dipendente",
    planFrom: "Dal", planTo: "Al", planNote: "Nota (facoltativo)", planSave: "Salva pianificazione",
    planUpcoming: "Assegnazioni pianificate", planEmpty: "Nessuna pianificazione.", planActive: "in corso",
    planPlanned: "pianificato", planConflictTitle: "Attenzione: sovrapposizione",
    planConflictText: "Questa attrezzatura è già pianificata per il periodo selezionato:", planSaveAnyway: "Salva comunque",
    planCancel: "Annulla", planPick: "— seleziona —",
    exportProjectLabel: "Progetto", exportTranslating: "Traduzione delle attività…",
    exportByEmployee: "Ore per dipendente", exportByProject: "Ore per progetto",
    kmStart: "Km iniziali", kmEnd: "Km finali", kmDriven: "Km percorsi", kmSave: "Salva km",
    kmWarnNegative: "Km finali inferiori a quelli iniziali – controllare",
    returnTitle: "Restituzione", returnQuestion: "Danno o particolarità?",
    returnPlaceholder: "es. graffio posteriore sinistro, utensile difettoso … (facoltativo)",
    returnConfirm: "Restituisci", returnNoteHistory: "Nota di restituzione",
    returnNoDamage: "Nessun danno", returnDamage: "Danno", returnOther: "Altro",
    eqReportTitle: "Esportazione mensile", eqReportVehicles: "Veicoli CSV", eqReportTools: "Utensili CSV",
    colFrom: "Dal", colTo: "Al", colDuration: "Durata (giorni)", colDamage: "Danno / nota", colOngoing: "in corso",
  },
  Serbisch: {
    planTitle: "Planiranje", planNew: "Novo planiranje", planEquipment: "Oprema", planEmployee: "Radnik",
    planFrom: "Od", planTo: "Do", planNote: "Napomena (opciono)", planSave: "Sačuvaj plan",
    planUpcoming: "Planirane dodele", planEmpty: "Nema planiranja.", planActive: "u toku",
    planPlanned: "planirano", planConflictTitle: "Pažnja: preklapanje",
    planConflictText: "Ova oprema je već planirana za izabrani period:", planSaveAnyway: "Ipak sačuvaj",
    planCancel: "Otkaži", planPick: "— izaberite —",
    exportProjectLabel: "Projekat", exportTranslating: "Prevodim aktivnosti…",
    exportByEmployee: "Sati po radniku", exportByProject: "Sati po projektu",
    kmStart: "Početni km", kmEnd: "Krajnji km", kmDriven: "Pređeni km", kmSave: "Sačuvaj km",
    kmWarnNegative: "Krajnji km manji od početnog – proverite",
    returnTitle: "Vraćanje", returnQuestion: "Oštećenje ili posebnost?",
    returnPlaceholder: "npr. ogrebotina pozadi levo, alat neispravan … (opciono)",
    returnConfirm: "Vrati", returnNoteHistory: "Napomena vraćanja",
    returnNoDamage: "Bez oštećenja", returnDamage: "Oštećenje", returnOther: "Ostalo",
    eqReportTitle: "Mesečni izvoz", eqReportVehicles: "Vozila CSV", eqReportTools: "Alat CSV",
    colFrom: "Od", colTo: "Do", colDuration: "Trajanje (dana)", colDamage: "Oštećenje / napomena", colOngoing: "još traje",
  },
  Spanisch: {
    planTitle: "Planificación", planNew: "Nueva planificación", planEquipment: "Equipo", planEmployee: "Empleado",
    planFrom: "Desde", planTo: "Hasta", planNote: "Nota (opcional)", planSave: "Guardar planificación",
    planUpcoming: "Asignaciones planificadas", planEmpty: "Sin planificaciones.", planActive: "en curso",
    planPlanned: "planificado", planConflictTitle: "Atención: solapamiento",
    planConflictText: "Este equipo ya está planificado para el período seleccionado:", planSaveAnyway: "Guardar de todos modos",
    planCancel: "Cancelar", planPick: "— seleccione —",
    exportProjectLabel: "Proyecto", exportTranslating: "Traduciendo actividades…",
    exportByEmployee: "Horas por empleado", exportByProject: "Horas por proyecto",
    kmStart: "Km inicial", kmEnd: "Km final", kmDriven: "Km recorridos", kmSave: "Guardar km",
    kmWarnNegative: "Km final menor que el inicial – verifique",
    returnTitle: "Devolución", returnQuestion: "¿Daño o particularidad?",
    returnPlaceholder: "p. ej. rayón trasero izquierdo, herramienta defectuosa … (opcional)",
    returnConfirm: "Devolver", returnNoteHistory: "Nota de devolución",
    returnNoDamage: "Sin daños", returnDamage: "Daño", returnOther: "Otros",
    eqReportTitle: "Exportación mensual", eqReportVehicles: "Vehículos CSV", eqReportTools: "Herramientas CSV",
    colFrom: "Desde", colTo: "Hasta", colDuration: "Duración (días)", colDamage: "Daño / nota", colOngoing: "en curso",
  },
  Philippinisch: {"planTitle":"Pagpaplano","planNew":"Bagong Pagpaplano","planEquipment":"Kagamitan","planEmployee":"Empleyado","planFrom":"Mula","planTo":"Hanggang","planNote":"Tala (opsyonal)","planSave":"I-save ang Pagpaplano","planUpcoming":"Mga Nakaplanong Talaga","planEmpty":"Walang pagpaplano.","planActive":"aktibo","planPlanned":"nakaplano","planConflictTitle":"Babala: Pagkakasalungat","planConflictText":"Ang kagamitang ito ay naka-iskedyul na sa napiling panahon:","planSaveAnyway":"I-save pa rin","planCancel":"Kanselahin","planPick":"— pumili —","exportProjectLabel":"Proyekto","exportTranslating":"Isinasalin ang mga gawain…","exportByEmployee":"Oras ng Empleyado","exportByProject":"Oras ng Proyekto","kmStart":"Simula-km","kmEnd":"Katapusan-km","kmDriven":"Napatakbong km","kmSave":"I-save ang km","kmWarnNegative":"Ang katapusan-km ay mas maliit kaysa simula-km – pakisuri","returnTitle":"Pagsasauli","returnQuestion":"May pinsala o kakaibang bagay?","returnPlaceholder":"hal. gasgas sa likod kaliwa, sirang kagamitan … (opsyonal)","returnConfirm":"Isauli","returnNoteHistory":"Tala sa Pagsasauli","returnNoDamage":"Walang Pinsala","returnDamage":"Pinsala","returnOther":"Iba pa","eqReportTitle":"Export ng Buwan","eqReportVehicles":"Sasakyan CSV","eqReportTools":"Kagamitan CSV","colFrom":"Mula","colTo":"Hanggang","colDuration":"Tagal (Araw)","colDamage":"Pinsala / Tala","colOngoing":"kasalukuyang isinasagawa"},
  Vietnamesisch: {"planTitle":"Lập kế hoạch","planNew":"Kế hoạch mới","planEquipment":"Thiết bị","planEmployee":"Nhân viên","planFrom":"Từ","planTo":"Đến","planNote":"Ghi chú (tùy chọn)","planSave":"Lưu kế hoạch","planUpcoming":"Phân bổ đã lên kế hoạch","planEmpty":"Không có kế hoạch nào.","planActive":"đang chạy","planPlanned":"đã lên kế hoạch","planConflictTitle":"Chú ý: Trùng lịch","planConflictText":"Thiết bị này đã được lên kế hoạch trong khoảng thời gian đã chọn:","planSaveAnyway":"Vẫn lưu","planCancel":"Hủy","planPick":"— vui lòng chọn —","exportProjectLabel":"Dự án","exportTranslating":"Đang dịch các hoạt động…","exportByEmployee":"Giờ công theo nhân viên","exportByProject":"Giờ công theo dự án","kmStart":"km đầu","kmEnd":"km cuối","kmDriven":"Số km đã đi","kmSave":"Lưu km","kmWarnNegative":"km cuối nhỏ hơn km đầu – vui lòng kiểm tra","returnTitle":"Trả lại","returnQuestion":"Có hư hỏng hoặc điều gì đặc biệt không?","returnPlaceholder":"ví dụ trầy xước phía sau bên trái, dụng cụ hỏng … (tùy chọn)","returnConfirm":"Trả lại","returnNoteHistory":"Ghi chú trả lại","returnNoDamage":"Không hư hỏng","returnDamage":"Hư hỏng","returnOther":"Khác","eqReportTitle":"Xuất theo tháng","eqReportVehicles":"Xe CSV","eqReportTools":"Dụng cụ CSV","colFrom":"Từ","colTo":"Đến","colDuration":"Thời lượng (ngày)","colDamage":"Hư hỏng / Ghi chú","colOngoing":"vẫn đang chạy"},
  Indisch: {"planTitle":"योजना","planNew":"नई योजना","planEquipment":"उपकरण","planEmployee":"कर्मचारी","planFrom":"से","planTo":"तक","planNote":"नोट (वैकल्पिक)","planSave":"योजना सहेजें","planUpcoming":"योजनाबद्ध आवंटन","planEmpty":"कोई योजना नहीं।","planActive":"चल रहा है","planPlanned":"योजनाबद्ध","planConflictTitle":"ध्यान दें: ओवरलैप","planConflictText":"यह उपकरण चुनी हुई अवधि में पहले से ही योजनाबद्ध है:","planSaveAnyway":"फिर भी सहेजें","planCancel":"रद्द करें","planPick":"— कृपया चुनें —","exportProjectLabel":"प्रोजेक्ट","exportTranslating":"गतिविधियों का अनुवाद हो रहा है…","exportByEmployee":"घंटे कर्मचारी","exportByProject":"घंटे प्रोजेक्ट","kmStart":"शुरुआती km","kmEnd":"अंतिम km","kmDriven":"चली गई km","kmSave":"km सहेजें","kmWarnNegative":"अंतिम km शुरुआती km से कम – कृपया जाँचें","returnTitle":"वापसी","returnQuestion":"क्षति या विशेष बात?","returnPlaceholder":"जैसे पीछे बाईं ओर खरोंच, औज़ार खराब … (वैकल्पिक)","returnConfirm":"वापस करें","returnNoteHistory":"वापसी नोट","returnNoDamage":"कोई क्षति नहीं","returnDamage":"क्षति","returnOther":"अन्य","eqReportTitle":"मासिक निर्यात","eqReportVehicles":"वाहन CSV","eqReportTools":"औज़ार CSV","colFrom":"से","colTo":"तक","colDuration":"अवधि (दिन)","colDamage":"क्षति / नोट","colOngoing":"अभी भी चल रहा है"},
};
